...
- `traceability/requirements/techco-operations.md` line 456: | `Order ends in state=partial` | BF3 NF not fully healthy, typically UDR not ready | Run `bash scripts/status.sh`. Check `build_logs/run/bf3_nfs.log`. The integration sweep's `wai
...
- `traceability/requirements/bf3-testing.md` line 1: # 3GPP Compliance Testing Guide
- `traceability/requirements/bf3-testing.md` line 5: This document provides comprehensive testing procedures for validating 3GPP compliance across all components of the 5G Network Simulator. It includes automated test suites, manual 
- `traceability/requirements/bf3-testing.md` line 10:                     3GPP Compliance Testing Framework
- `traceability/requirements/bf3-testing.md` line 14: │  │                    Compliance Test Suite                               │   │
- `traceability/requirements/bf3-testing.md` line 24: │  │  │   Message    │ │  Compliance  │ │   Timeline   │ │ Performance  │  │   │
- `traceability/requirements/bf3-testing.md` line 41: ### 1. Protocol Compliance Tests
- `traceability/requirements/bf3-testing.md` line 45: **File:** `test_3gpp_compliance.py` (Enhanced)
- `traceability/requirements/bf3-testing.md` line 55: class ProtocolComplianceTests:
- `traceability/requirements/bf3-testing.md` line 57:     Comprehensive 3GPP protocol compliance testing
- `traceability/requirements/bf3-testing.md` line 62:         self.compliance_scores = {}
- `traceability/requirements/bf3-testing.md` line 64:     async def test_n11_interface_compliance(self):

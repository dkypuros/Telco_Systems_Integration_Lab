...
"Agentic Telecom" isn't just about an LLM writing scripts. The core of this lab is a massive safety and governance harness that turns O-RAN and 3GPP components into constrained, trackable *skills*—a tightly governed execution paradigm for telecommunications.
...
The foundational concept of wrapping AI agents in a strict safety and governance boundary was deeply inspired by the [Oh My Codex](https://github.com/10xeng-HQ/oh-my-codex) paradigm by Bellman. This repository implements a highly specialized, stripped-down evolution of that concept specifically designed for the constraints and rigors of telecommunications networks and the O-RAN portfolio.
